...
void menu_maybe_init ( void )
{
	...
	menu_item_add(OverLight_CarFunctions_Menu, NULL, "Use Friends on Target", ID_USE_FRIEND_TARGET, MENU_COLOR_DEFAULT, NULL, "Troll your friend in friendlist too.");
	...
	menu_item_add(menu_main, OverLight_PlayerFunctions_Menu, "Player Functions", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "\tSync Modifications", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Invert Walk", ID_INVERT_WALK, MENU_COLOR_DEFAULT, NULL, "Walk upside down.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Moon Walk", ID_INVERT_WALK_2, MENU_COLOR_DEFAULT, NULL, "Walk like Michael Jackson.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Wheel Walk", ID_WHEEL_WALK, MENU_COLOR_DEFAULT, NULL, "Walk like a wheel.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Player Hologram", ID_PLAYER_HOLOGRAM_MODE, MENU_COLOR_DEFAULT, NULL, "Aka ghost mode");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Vehicle Hologram", ID_CAR_HOLOGRAM_MODE, MENU_COLOR_DEFAULT, NULL, "Remove collision on vehicles");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "No Fall", ID_NOFALL, MENU_COLOR_DEFAULT, NULL, "Skip the fall animation.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Invalid Aim Z", ID_INVALID_AIMZ, MENU_COLOR_DEFAULT, NULL, "Remove your head while you are aiming.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "\tSync Troll", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Use Nearest Player", ID_USE_NEAREST_PLAYER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "\aTarget: //", ID_SELECT_PLAYER_TARGET_2, MENU_COLOR_DEFAULT, NULL, "Disable \"Use nearest...\" to use it with - +");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Slapper", ID_SLAPPER, MENU_COLOR_DEFAULT, NULL, "Sweep away the players.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Skin Elevator", ID_ELEVATOR, MENU_COLOR_DEFAULT, NULL, "Drag the player in sky.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Skin Elevator With Jetpack", ID_JETPACK_ELEVATOR, MENU_COLOR_DEFAULT, NULL, "Drag the player in sky.");
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "\tFriends", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_PlayerFunctions_Menu, NULL, "Use Friends on Target", ID_USE_FRIEND_TARGET2, MENU_COLOR_DEFAULT, NULL, "Troll your friend in friendlist too.");
	...
	menu_item_add(menu_main, OverLight_DM_Stuff_Menu, "DeathMatch Stuff", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\tSilent Aimbot - Lagcomp ON/OFF", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Silent Aim", ID_SILENT_AIM, MENU_COLOR_DEFAULT, NULL);
	OverLight_Silent_Advanced = menu_new(OverLight_DM_Stuff_Menu, 0, OverLight_Silent_Aim_Stuff_Callback);
	menu_item_add(OverLight_DM_Stuff_Menu, OverLight_Silent_Advanced, "Silent Aim Advanced Options", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	
	menu_item_add(OverLight_Silent_Advanced, NULL, "\tSilent Aim Advanced Options", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "\aRandomize offset aim: //", ID_INACCURATE_AIM, MENU_COLOR_DEFAULT, NULL, "Decrease to get more accurate aim but more detectable.");
	menu_item_add(OverLight_Silent_Advanced, NULL, "\tAim only to:", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not Friends", ID_FILTER_FRIEND, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not In My Team", ID_FILTER_TEAM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not Same My Nick Color", ID_FILTER_COLOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not Same My Skin", ID_FILTER_SKIN, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not Out Of Range", ID_NOT_OUT_OF_RANGE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Visible Skin", ID_FILTER_VISIBLE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not AFK", ID_FILTER_AFK, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Silent_Advanced, NULL, "Not Die", ID_FILTER_ALIVE, MENU_COLOR_DEFAULT, NULL);


	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Shot Through Wall", ID_SHOT_WALL, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Possible Bypass Anti Cheat", ID_BYPASS_ANTICHEAT, MENU_COLOR_DEFAULT, NULL, "Use it if anticheat detects the silent aim.");
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Possible Bypass Anti Cheat 2", ID_BYPASS_ANTICHEAT_2, MENU_COLOR_DEFAULT, NULL, "Use it if anticheat detects the silent aim.");
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Auto C Bug", ID_AUTO_C_BUG, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Auto Scroll 2-2", ID_AUTO_SCROLL, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Auto Shot", ID_AUTOSHOT, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "No Spread", ID_NOSPREAD, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Anti Stun", ID_ANTISTUN, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Slow Aiming", ID_SLOWSENSAIM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\aSlow aim: //", ID_SLOWINC, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\tFake Lag (Sync/No-Sync)", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Fake Lag", ID_FAKE_LAG_SYNC, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\aTime Sync: // ms", ID_FAKE_LAG_TIME_SYNC, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\aTime No-Sync (AFK): // ms", ID_FAKE_LAG_TIME_DESYNC, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Sync When Aim", ID_SYNC_WHEN_AIM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\tFake Lag (Fake Speed)", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Fake Lag / Fake Speed", ID_FAKE_LAG_SPEED, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\aSpeed Multipler: //", ID_SPEED_MULTIPLIER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "\tUtilities DM Cheats", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Shot Repeater", ID_SHOT_REPEATER, MENU_COLOR_DEFAULT, NULL, "Resend the bullet that you have received.");
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Draw Finder", ID_DRAW_FINDER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_DM_Stuff_Menu, NULL, "Custom Chams", ID_CHAMS, MENU_COLOR_DEFAULT, NULL);
	OverLight_Chams_Advanced = menu_new(OverLight_DM_Stuff_Menu, 0, OverLight_Chams_Callback);
	menu_item_add(OverLight_DM_Stuff_Menu, OverLight_Chams_Advanced, "Chams Advanced Options", ID_NONE, MENU_COLOR_DEFAULT, NULL);


	menu_item_add(OverLight_Chams_Advanced, NULL, "\tColor Hidden", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aAlpha: //", ID_BEHIND_ALPHA, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aRed: //", ID_BEHIND_RED, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aGreen: //", ID_BEHIND_GREEN, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aBlue: //", ID_BEHIND_BLUE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Solid", ID_BEHIND_SOLID, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Wireframe", ID_BEHIND_WIREFRAME, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Point", ID_BEHIND_POINT, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\tColor Showed", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aAlpha: //", ID_INFRONT_ALPHA, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aRed: //", ID_INFRONT_RED, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aGreen: //", ID_INFRONT_GREEN, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "\aBlue: //", ID_INFRONT_BLUE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Solid", ID_INFRONT_SOLID, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Wireframe", ID_INFRONT_WIREFRAME, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chams_Advanced, NULL, "Point", ID_INFRONT_POINT, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(menu_main, OverLight_Bot_Stuff_Menu, "Bot Stuff", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\tAdd/Delete Bot", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Connect Bot", ID_CONNECT_BOT, MENU_COLOR_DEFAULT, NULL, "Connect a bot to use functions.");
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Connect n Bots", ID_N_CONNECT_BOT, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(OverLight_Bot_Stuff_Menu, OverLight_Bot_Connect_Advanced, "Bot Connect Advanced Options", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "\tConnect Settings", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "Normal Nickname", ID_MENU_NICK_LOCAL, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "Realistic Nickname", ID_MENU_NICK_REALISTIC, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "Binary Nickname", ID_MENU_NICK_BINARY, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "\aClass ID: //", ID_BOT_CLASS_ID, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "Spawn from this Class", ID_BOT_SPAWN2, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "\tFrom Another Player", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "\aPlayer: //", ID_BOT_PLAYER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Connect_Advanced, NULL, "Steal Nickname", ID_BOT_STEAL_NICK, MENU_COLOR_DEFAULT, NULL);

	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Spawn", ID_BOT_SPAWN, MENU_COLOR_DEFAULT, NULL, "Spawn again if you don't see the bot or use some func.");

	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Delete Bot", ID_DELETE_BOT, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Delete All Bot", ID_DELETE_ALL_BOT, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\tBot Funcs", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Follow", ID_BOT_FOLLOW, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\aDistance From Player: //", ID_BOT_DISTANCE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\aDistance From Bots: //", ID_BOT_DISTANCE_2, MENU_COLOR_DEFAULT, NULL);
	OverLight_Bot_Follow_Advanced = menu_new(OverLight_Bot_Stuff_Menu, 0, OverLight_Bot_Follow_Callback);
	menu_item_add(OverLight_Bot_Stuff_Menu, OverLight_Bot_Follow_Advanced, "Bot Advanced Options", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Shooter", ID_BOT_SHOOTER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\tBot Troll Cheats", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\aTarget ID: //", ID_BOT_SELECT_TARGET, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Use Nearest Target/Player", ID_BOT_USE_NEAREST_TARGET, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Attacker", ID_BOT_ATTACKER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\aBot Att. Weapon ID: \\", ID_BOT_WEAPON, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Slapper", ID_BOT_SLAPPER, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Elevator", ID_BOT_ELEVATOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Jetpack Elevator", ID_BOT_JETPACK_ELEVATOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Fuck", ID_BOT_FUCK, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Follow Anim", ID_BOT_FOLLOW_ANIM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "\aBot Foll. Anim ID: \\", ID_BOT_FOLLOW_SEL_ANIM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Sun", ID_BOT_SUN, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Storm", ID_BOT_STORM, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Pick/Drag Bot", ID_BOT_PICK, MENU_COLOR_DEFAULT, NULL);
	
	OverLight_Bot_Pick_Control_Advanced = menu_new(OverLight_Bot_Stuff_Menu, 0, OverLight_Bot_Control_Callback);
	menu_item_add(OverLight_Bot_Stuff_Menu, OverLight_Bot_Pick_Control_Advanced, "Bot Pick/Control Advanced", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Stuff_Menu, NULL, "Bot Delay", ID_BOT_DELAY, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(OverLight_Bot_Pick_Control_Advanced, NULL, "Bot ID: //", ID_BOT_ID, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Bot_Pick_Control_Advanced, NULL, "\aAnimation ID: //", ID_BOT_ANIMATION, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(OverLight_Graphics_Stuff_Menu, NULL, "\aMat. Amb. Color: //", ID_MAT_AMBIENTCOLOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Graphics_Stuff_Menu, NULL, "\aLight Amb. Color: //", ID_LIGHT_AMBIENTCOLOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Graphics_Stuff_Menu, NULL, "\aMat. Diff. Color: //", ID_MAT_DIFFUSECOLOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Graphics_Stuff_Menu, NULL, "\aLight Diff. Color: //", ID_LIGHT_DIFFUSECOLOR, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Graphics_Stuff_Menu, NULL, "\aMat. Emes. Color: //", ID_MAT_EMESSIVECOLOR, MENU_COLOR_DEFAULT, NULL);



	struct menu *OverLight_HUD_Settings;
	OverLight_HUD_Settings = menu_new(menu_main, 0, OverLight_HUD_Settings_Callback);
	menu_item_add(menu_main, OverLight_HUD_Settings, "HUD Settings", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_HUD_Settings, NULL, "Custom Players Tags", ID_PLAYER_TAGS, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_HUD_Settings, NULL, "Vehicles Tags", ID_VEHICLE_TAGS, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_HUD_Settings, NULL, "\tFonts Settings", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_HUD_Settings, NULL, "\aFont Chat Size: \\", ID_FONT_CHAT_SIZE, MENU_COLOR_DEFAULT, NULL, "Press ENTER for save, and restart the game");
	menu_item_add(OverLight_HUD_Settings, NULL, "\aFont Small Size: \\", ID_FONT_SMALL_SIZE, MENU_COLOR_DEFAULT, NULL, "Press ENTER for save, and restart the game");
	menu_item_add(OverLight_HUD_Settings, NULL, "\aFont Footer Size: \\", ID_FONT_FOOTER_SIZE, MENU_COLOR_DEFAULT, NULL, "Press ENTER for save, and restart the game");
	menu_item_add(OverLight_HUD_Settings, NULL, "\aFont Menu Size: \\", ID_FONT_MENU_SIZE, MENU_COLOR_DEFAULT, NULL, "Press ENTER for save, and restart the game");


	struct menu *OverLight_Chat_Settings;
	OverLight_Chat_Settings = menu_new(menu_main, 0, OverLight_Chat_Callback);
	menu_item_add(menu_main, OverLight_Chat_Settings, "Chat Settings", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chat_Settings, NULL, "Remove Chat Background", ID_TRANSP, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chat_Settings, NULL, "\tOL Chat Privacy", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chat_Settings, NULL, "Send Nickname", ID_SEND_NICKNAME, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Chat_Settings, NULL, "Send Current Server", ID_SEND_SERVER, MENU_COLOR_DEFAULT, NULL);
	...
	menu_item_add(menu_main, OverLight_Crashers, "Crashers", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Crashers, NULL, "Vortex Crasher v2", ID_VORTEX_CRASHER2, MENU_COLOR_DEFAULT, NULL, "You NEED drive a Plane or Vortex to use it.");
	menu_item_add(OverLight_Crashers, NULL, "Plane Crasher v2", ID_PLANE_CRASHER2, MENU_COLOR_DEFAULT, NULL, "You NEED drive a Plane or Vortex to use it.");
	menu_item_add(OverLight_Crashers, NULL, "Vortex Crasher v1", ID_VORTEX_CRASHER_, MENU_COLOR_DEFAULT, NULL, "You NEED drive a Plane or Vortex to use it.");
	menu_item_add(OverLight_Crashers, NULL, "Plane Crasher v1", ID_PLANE_CRASHER_, MENU_COLOR_DEFAULT, NULL, "You NEED drive a Plane or Vortex to use it.");
	menu_item_add(OverLight_Crashers, NULL, "Bullet Crasher", ID_BULLET_CRASHER, MENU_COLOR_DEFAULT, NULL, "You need a vehicle and a weapon.");
	menu_item_add(OverLight_Crashers, NULL, "Car Jack Crasher", ID_CARJACK_CRASHER, MENU_COLOR_DEFAULT, NULL, "You need a driver and a weapon.");
	menu_item_add(OverLight_Crashers, NULL, "Plane Crasher v3", ID_STUNT_CRASHER, MENU_COLOR_DEFAULT, NULL, "Works with Stuntplane Shamal Hydra.");
	menu_item_add(OverLight_Crashers, NULL, "Hunter Crasher", ID_HUNTER_CRASHER, MENU_COLOR_DEFAULT, NULL, "Works with Hunter.");
	menu_item_add(OverLight_Crashers, NULL, "Detonator Crasher", ID_DETONATOR_CRASHER, MENU_COLOR_DEFAULT, NULL, "On Foot Crasher.");
	menu_item_add(OverLight_Crashers, NULL, "Jetpack Roll Crasher", ID_JETPACK_ROLL_CRASHER, MENU_COLOR_DEFAULT, NULL, "Never gonna give you Jetpack.");
	...
	menu_item_add(menu_main, OverLight_Credits_Menu, "OverLight Credits", 1, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "Mod S0beit OverLight", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "by RcK.", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "Special thanks to", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "Enacostione, Krakazabra", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "and mod s0beit Developers.", ID_NONE, MENU_COLOR_DEFAULT, NULL);
	menu_item_add(OverLight_Credits_Menu, NULL, "Thanks Heron for beta tester.", ID_NONE, MENU_COLOR_DEFAULT, NULL);
