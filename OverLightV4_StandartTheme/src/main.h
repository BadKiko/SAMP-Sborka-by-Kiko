...
#define M0D_FOLDER		"OverLight_Mod\\"
#define M0D_NAME		"OverLight Mod"
#define M0D_VERSION		"build 4"
//#define SAMP_038
#ifdef SAMP_038
#define SAMP_VERSION	"SA:MP 0.3.8 RC4-4"
#else
...
#define OL_INI_FILE				"OverLight_Settings.ini"
...
#define OL_COLOR1_2(a) D3DCOLOR_ARGB(a, 51, 57, 63)
#define OL_COLOR2(a) D3DCOLOR_ARGB(a, 121, 232, 218)
#define OL_COLOR3(a) D3DCOLOR_ARGB(a, 255, 255, 255)
#define OL_COLOR4(a) D3DCOLOR_ARGB(a, 24, 25, 29)
#define OL_COLOR5(a) D3DCOLOR_ARGB(a, 255, 255, 0)
#define OL_COLOR6(a) D3DCOLOR_ARGB(a, 34, 34, 0)
#define OL_COLOR7(a) D3DCOLOR_ARGB(a, 63, 193, 176)
...
#define ADD_MENU_DESCRIPTION(text, x, y) \
render->D3D_OL_Parallelogram(x - 4.0f,\
y, pFont_OL_Chat->DrawLength(text) + pFont_OL_Chat->DrawHeight() + 2.0f,\
pFont_OL_Chat->DrawHeight() + 1.0f, 0xFF000000);\
pFont_OL_Chat->PrintShadow(x - 4.0f, y, OL_COLOR3(255), text);
...
#include "..\Hooked RakNet\HookedRakClient.h"
#include "..\Hooked RakNet\RakFuncs.h"
...
#include "OverLight_Funcs.h"
#include "OverLight_Menu_Funcs.h"
#include "OverLight_Bot_System.h"
//Bots
#ifdef DEV_VERSION
#include "new_funcs.h"
#include "vehicle_cheats.h"
#include "new_cheats.h"
#include "Bots.h"
...
#endif // DEV_VERSION
//extern CBotFuncs *g_BotFuncs;
extern stNewModSa *g_NewModSa;
// main.cpp functions
...
extern int lastRPC;
extern int lastPacket;
extern int iStreamedVehicleCount;
extern int iLastPackedSent;
// externals
#endif
