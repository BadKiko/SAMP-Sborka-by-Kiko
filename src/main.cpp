...
void Log ( const char *fmt, ... )
{
	...
	{
		char	filename[512];
		snprintf( filename, sizeof(filename), "%s\\" M0D_FOLDER "%s", g_szWorkingDirectory, "la_pirula_project.log" );
	...
	if ( g_flLogAll == NULL )
	{
		...
		snprintf( filename_all, sizeof(filename_all), "%s\\" M0D_FOLDER "%s", g_szWorkingDirectory, "la_pirula_project_all.log" );
...
void LogChatbox ( bool bLast, const char *fmt, ... )
{
	...
	{
		char	filename[512];
		snprintf( filename, sizeof(filename), "%s\\" M0D_FOLDER "%s", g_szWorkingDirectory, "la_pirula_project_chatbox.log" );
	...
	{
		char	filename_all[512];
		snprintf( filename_all, sizeof(filename_all), "%s\\" M0D_FOLDER "%s", g_szWorkingDirectory, "la_pirula_project_chatbox_all.log" );
