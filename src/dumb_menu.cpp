...
#define ID_MENU_CHEATS_VISION				3
#define ID_MENU_CHEATS_PULSATOR				4
...
#define ID_CHEAT_SUICIDE					130
#define ID_CHEAT_GRAVITY					160
#define ID_CHEAT_AUTOAIM					161
#define ID_CHEAT_MAPRUN						170
#define ID_CHEAT_TELETEXTS					180
#define ID_CHEAT_GAME_SPEED					190
#define ID_CHEAT_HANDLING					200
#define ID_CHEAT_KEEP_TRAILER				210
#define ID_CHEAT_NOCOLS_ACTORS				220
#define ID_CHEAT_NOCOLS_VEHICLES			230
#define ID_CHEAT_WALLHACK					240
#define ID_CHEAT_WIREFRAME					250
#define ID_CHEAT_CHAMS						260
#define ID_CHEAT_CUSTOM_RUNSTYLE			270
#define ID_CHEAT_USE_BOSSFLY				280
#define ID_CHEAT_FLY_SPEED					290
#define ID_CHEAT_DISABLE_WAVES				300
...
#define ID_MISC_ANTTWEAK_MENU				7
...
#define ID_DEBUG_SAMP_DIALOG_INFO			10
#define ID_DEBUG_SAMP_VEHICLE_LIST			11
#define ID_DEBUG_SAMP_LOCAL_SAMPPED			12
...
#define ID_HUDIND_NOCOLLISION				6
#define ID_HUDIND_INVEH_AIRBRK				7
#define ID_HUDIND_INVEH_AUTOPILOT			8
#define ID_HUDIND_INVEH_ITROLL				9
#define ID_HUDIND_INVEH_STICK				10
#define ID_HUDIND_INVEH_BRKDANCE			11
#define ID_HUDIND_INVEH_SPIDER				12
#define ID_HUDIND_INVEH_FLY					13
#define ID_HUDIND_ONFOOT_AIRBRK				14
#define ID_HUDIND_ONFOOT_STICK				15
#define ID_HUDIND_ONFOOT_AIMBOT				16
#define ID_HUDIND_ONFOOT_FLY				17
#define ID_HUDIND_ONFOOT_MAPRUN				18
#define ID_HUDIND_FPS						19
#define ID_HUDIND_LB_BARS					20
...
static void menu_cheats_mods_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tVehicle upgrades", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_cheats_spoof_kill_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tFake kill", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_vehicles_populate ( struct menu *menu, int class_id )
{
	...
	snprintf( name, sizeof(name), "\t%s", gta_vehicle_class_name(class_id) );
	menu_item_add( menu, NULL, name, ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_players_warp_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tWarp to player", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_players_vehwarp_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tWarp instantly to player's vehicle", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_vehicles_instant_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tWarp instantly to vehicle", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_players_spectator_mode_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tSpectate player", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_telepickup_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tTeleport to pickup", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_teleobject_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tTeleport to object", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_handling_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tChange vehicle handling", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_playerinfo_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tShow infos on player", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static void menu_playermute_populate ( struct menu *menu )
{
	...
	menu_item_add( menu, NULL, "\tMute player chat (Anti-spam)", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
...
static int menu_callback_cheats_vision ( int op, struct menu_item *item )
{
	switch ( op )
	{
		case MENU_OP_ENABLED:
		{
			switch ( item->id )
			{
				case ID_CHEAT_WALLHACK:
					return set.wallhack_on;

				case ID_CHEAT_WIREFRAME:
					return set.wireframe_on;
...
static int menu_callback_cheats ( int op, struct menu_item *item )
{
	...
	case MENU_OP_ENABLED:
		...
		case ID_CHEAT_SUICIDE:
			return 0;

		case ID_CHEAT_GRAVITY:
			return 0;

		case ID_CHEAT_AUTOAIM:
			return cheat_state->actor.autoaim;

		case ID_CHEAT_MAPRUN:
			return cheat_state->_generic.maprun;
		...
		case ID_CHEAT_NOCOLS_ACTORS:
			return cheat_state->_generic.nocols_actors_enabled;

		case ID_CHEAT_NOCOLS_VEHICLES:
			return cheat_state->_generic.nocols_vehicles_enabled;

		case ID_CHEAT_CUSTOM_RUNSTYLE:
			return set.custom_runanimation_enabled;

		case ID_CHEAT_USE_BOSSFLY:
			return set.use_bossfly;
	...
	case MENU_OP_SELECT:
		...
		case ID_CHEAT_NOCOLS_ACTORS:
			cheat_state->_generic.nocols_actors_enabled ^= 1;
			break;

		case ID_CHEAT_NOCOLS_VEHICLES:
			cheat_state->_generic.nocols_vehicles_enabled ^= 1;
			break;
...
static int menu_callback_misc ( int op, struct menu_item *item )
{
	...
	if ( op == MENU_OP_ENABLED )
	{
		...
		case ID_MISC_ANTTWEAK_MENU:
			return set.ant_tweak_menu;
		}
	}
	else if ( op == MENU_OP_SELECT )
	{
		...
		case ID_MISC_ANTTWEAK_MENU:
			set.ant_tweak_menu ^= 1;
			if ( !set.ant_tweak_menu && cheat_state->_generic.new_menu )
...
void TriggerPlayerWarpMenu(int ID)
{
	...
	menu_callback_players_warp(MENU_OP_SELECT, &item);
}
...
static int menu_callback_debug ( int op, struct menu_item *item )
{
	...
	if ( op == MENU_OP_SELECT )
	{
		...
		case ID_DEBUG_SAMP_DIALOG_INFO:
			setDebugPointer( (void *)g_Dialog );
			break;
...
static int menu_callback_hudindicators ( int op, struct menu_item *item )
{
	if ( op == MENU_OP_ENABLED )
	{
		...
		case ID_HUDIND_NOCOLLISION:
			return set.hud_indicator_nocollision;
			break;
		...
		case ID_HUDIND_INVEH_AUTOPILOT:
			return set.hud_indicator_inveh_autopilot;
			break;

		case ID_HUDIND_INVEH_ITROLL:
			return set.hud_indicator_inveh_itroll;
			break;
		...
		case ID_HUDIND_ONFOOT_AIMBOT:
			return set.hud_indicator_onfoot_aimbot;
			break;

		case ID_HUDIND_ONFOOT_MAPRUN:
			return set.hud_indicator_onfoot_maprun;
			break;
	...
	if ( op == MENU_OP_SELECT )
	{
		...
		case ID_HUDIND_NOCOLLISION:
			set.hud_indicator_nocollision ^= 1;
			break;
		...
		case ID_HUDIND_INVEH_AUTOPILOT:
			set.hud_indicator_inveh_autopilot ^= 1;
			break;

		case ID_HUDIND_INVEH_ITROLL:
			set.hud_indicator_inveh_itroll ^= 1;
			break;
		...
		case ID_HUDIND_ONFOOT_AIMBOT:
			set.hud_indicator_onfoot_aimbot ^= 1;
			break;

		case ID_HUDIND_ONFOOT_MAPRUN:
			set.hud_indicator_onfoot_maprun ^= 1;
			break;
...
static int menu_callback_gethere ( int op, struct menu_item *item )
{
	if ( g_Players == NULL )
		return 0;
...
static int menu_callback_sendcars ( int op, struct menu_item *item )
{
	if ( g_Players == NULL )
		return 0;
	...
	if ( op == MENU_OP_SELECT )
	{
		if ( id < SAMP_PLAYER_MAX && id >= 0 )
		{
			moveStreamedVehiclesToPlayer(id);
			return 1;
		}
...
void menu_maybe_init ( void )
{
	...
	struct menu *menu_main, *menu_cheats, *menu_cheats_mods, *menu_cheats_vision, *menu_cheats_pulsator, *menu_cheats_inv, *menu_cheats_money, *menu_cheats_weather, *menu_cheats_time, *
				menu_weapons, *menu_vehicles, *menu_teleports, *menu_interiors, *menu_misc, *menu_debug, *menu_hudindicators, *menu_patches,
				*menu_players, *menu_servers, *menu_players_warp, *menu_players_vehwarp, *menu_players_spec, //*menu_cheats_handling,
						*menu_player_info, *menu_players_mute, *menu_sampmisc, *menu_spoof_weapon, *menu_fake_kill,
							*menu_vehicles_instant, *menu_gamestate, *menu_specialaction, *menu_teleobject, *menu_telepickup, *menu_samppatches;
	...
	menu_cheats_vision = menu_new( menu_cheats, ID_MENU_CHEATS_VISION, menu_callback_cheats_vision );
	...
	menu_item_add( menu_cheats, NULL, "\tCheats", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	menu_item_add( menu_cheats, menu_cheats_mods, "Vehicle upgrades", ID_CHEAT_MODS, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats, menu_cheats_vision, "Vision assistance", ID_CHEAT_VISION, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_cheats, NULL, "Suicide", ID_CHEAT_SUICIDE, MENU_COLOR_DEFAULT, NULL );
	...
	if ( g_dwSAMP_Addr == NULL ) menu_item_add( menu_cheats, NULL, "Autoaim", ID_CHEAT_AUTOAIM, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats, NULL, "MapRun", ID_CHEAT_MAPRUN, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_cheats, NULL, "Toggle actor collisions", ID_CHEAT_NOCOLS_ACTORS, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats, NULL, "Toggle vehicle collisions", ID_CHEAT_NOCOLS_VEHICLES, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_cheats, NULL, "Use BossFly", ID_CHEAT_USE_BOSSFLY, MENU_COLOR_DEFAULT, NULL );
	...
	/* main_menu -> cheats -> vision assistance */
	menu_item_add( menu_cheats_vision, NULL, "\tVision assistance", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	menu_item_add( menu_cheats_vision, NULL, "Wallhack", ID_CHEAT_WALLHACK, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats_vision, NULL, "Wireframe", ID_CHEAT_WIREFRAME, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_cheats_vision, NULL, "Chams", ID_CHEAT_CHAMS, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_cheats_inv, NULL, "\tInvulnerable", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	menu_item_add( menu_cheats_money, NULL, "\tMoney", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	menu_item_add( menu_cheats_weather, NULL, "\tFreeze weather", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	for ( i = 0;; i++ )
	{
	...
	menu_item_add( menu_cheats_time, NULL, "\tFreeze time", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	for ( i = 0; i < 24; i++ )
	{
	...
	/* main menu -> weapons */
	menu_item_add( menu_weapons, NULL, "\tWeapons", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	/* main menu -> vehicles */
	menu_item_add( menu_vehicles, NULL, "\tVehicles", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	/* main menu -> patches */
	snprintf( name, sizeof(name), "GTA Patches (%d/%d)", iGTAPatchesCount, INI_PATCHES_MAX );
	menu_item_add( menu_patches, NULL, name, ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	{
		/* main menu -> players */
		menu_item_add( menu_players, NULL, "\tPlayers", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
		...
		// samp patches
		snprintf( name, sizeof(name), "\tSA:MP Patches (%d/%d)", iSAMPPatchesCount, INI_SAMPPATCHES_MAX );
		menu_item_add( menu_samppatches, NULL, name, ID_NONE, MENU_COLOR_SEPARATOR, NULL );
		...
		// server list
		snprintf( name, sizeof(name), "Fav. server list (%d/%d)", iServersCount, INI_SERVERS_MAX );
		menu_item_add( menu_servers, NULL, name, ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	/* teleports */
	menu_item_add( menu_teleports, NULL, "\tTeleports", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	menu_item_add( menu_interiors, NULL, "\tTeleport to interiors", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	/* misc */
	menu_item_add( menu_misc, NULL, "\tMisc.", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	menu_item_add( menu_misc, NULL, "AntTweakBar menu", ID_MISC_ANTTWEAK_MENU, MENU_COLOR_DEFAULT, NULL );

	/* misc -> debug */
	menu_item_add( menu_debug, NULL, "\tDebug", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	if ( g_dwSAMP_Addr != NULL )
	{
		...
		menu_item_add( menu_debug, NULL, "SA:MP Dialog info", ID_DEBUG_SAMP_DIALOG_INFO, MENU_COLOR_DEFAULT, NULL );
		menu_item_add( menu_debug, NULL, "SA:MP Local SAMP-PED", ID_DEBUG_SAMP_LOCAL_SAMPPED, MENU_COLOR_DEFAULT, NULL );
	}

	// misc -> HUD indicators
	menu_item_add( menu_hudindicators, NULL, "\tToggle HUD indicators", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
	...
	menu_item_add( menu_hudindicators, NULL, "Invulnerable", ID_HUDIND_INV, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_hudindicators, NULL, "In vehicle AutoPilot", ID_HUDIND_INVEH_AUTOPILOT, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_hudindicators, NULL, "In vehicle iTroll", ID_HUDIND_INVEH_ITROLL, MENU_COLOR_DEFAULT, NULL );
	...
	menu_item_add( menu_hudindicators, NULL, "On foot Aimbot", ID_HUDIND_ONFOOT_AIMBOT, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_hudindicators, NULL, "On foot Fly", ID_HUDIND_ONFOOT_FLY, MENU_COLOR_DEFAULT, NULL );
	menu_item_add( menu_hudindicators, NULL, "On foot MapRun", ID_HUDIND_ONFOOT_MAPRUN, MENU_COLOR_DEFAULT, NULL );
	...
	{
		// main menu -> sampmisc
		menu_item_add( menu_sampmisc, NULL, "\tSA:MP Misc.", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
		...
		menu_item_add( menu_gamestate, NULL, "\tChange game state", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
		...
		menu_item_add( menu_specialaction, NULL, "\tSpecial action", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
		...
		menu_item_add( menu_spoof_weapon, NULL, "\tSpoof weapon", ID_NONE, MENU_COLOR_SEPARATOR, NULL );
