...
struct settings
{
	...
	int						hud_indicator_nocollision;

	int						hud_indicator_inveh_airbrk;
	int						hud_indicator_inveh_autopilot;
	int						hud_indicator_inveh_itroll;
	...
	int						hud_indicator_onfoot_aimbot;
	int						hud_indicator_onfoot_stick;
	int						hud_indicator_onfoot_fly;
	int						hud_indicator_onfoot_maprun;
	...
	*/
	...
	int						car_remote_control_with_driver;
	int						car_remote_control_without_driver;
	...
	char					ap_destination_name[STATIC_TELEPORT_MAX][INI_STRLEN_MAX];
	struct settings_coord	ap_destination[STATIC_TELEPORT_MAX];

	int						infoboxes_near_playertags;
