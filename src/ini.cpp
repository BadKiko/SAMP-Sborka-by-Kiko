...
static void ini_init ( void )
{
	...
	if ( (ent = ini_register_entry("secondary_key", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.secondary_key, "oem_minus" );
	...
	*/
	...
	if ( (ent = ini_register_entry("use_bossfly", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.use_bossfly, "true" );
	...
	*/
	...
	/* maprun */
	if ( (ent = ini_register_entry("key_maprun", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.key_maprun, "m" );
	...
	/* new menu */
	if ( (ent = ini_register_entry("key_new_menu", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.key_new_menu, "f2" );
	if ( (ent = ini_register_entry("new_menu_populator_time", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.new_menu_populator_time, "200" );
	if ( (ent = ini_register_entry("ant_tweak_menu", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.ant_tweak_menu, "true" );
	...
	if ( (ent = ini_register_entry("hud_indicator_nocollision", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_nocollision, "true" );
	...
	if ( (ent = ini_register_entry("hud_indicator_inveh_autopilot", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_inveh_autopilot, "true" );
	if ( (ent = ini_register_entry("hud_indicator_inveh_itroll", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_inveh_itroll, "true" );
	...
	if ( (ent = ini_register_entry("hud_indicator_onfoot_aimbot", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_onfoot_aimbot, "true" );
	if ( (ent = ini_register_entry("hud_indicator_onfoot_fly", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_onfoot_fly, "true" );
	if ( (ent = ini_register_entry("hud_indicator_onfoot_maprun", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.hud_indicator_onfoot_maprun, "true" );
	...
	if ( (ent = ini_register_entry("wallhack_on", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.wallhack_on, "false" );
	if ( (ent = ini_register_entry("wireframe_on", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.wireframe_on, "false" );
	...
	if ( (ent = ini_register_entry("d3dtext_chat", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.d3dtext_chat, "true" );
	if ( (ent = ini_register_entry("d3dtext_chat_lines", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.d3dtext_chat_lines, "10" );

	if ( (ent = ini_register_entry("d3dtext_kill", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.d3dtext_kill, "false" );
	if ( (ent = ini_register_entry("d3dtext_score", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.d3dtext_score, "false" );
	...
	if ( (ent = ini_register_entry("anti_carjacking", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.anti_carjacking, "false" );
	...
	if ( (ent = ini_register_entry("key_rejoin", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.key_rejoin, "0" );
	if ( (ent = ini_register_entry("rejoin_delay", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.rejoin_delay, "0" );
	...
	if ( (ent = ini_register_entry("car_remote_control_with_driver", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.car_remote_control_with_driver, "true" );

	if ( (ent = ini_register_entry("car_remote_control_without_driver", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.car_remote_control_without_driver, "false" );

	if ( (ent = ini_register_entry("key_dialoghider", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.key_dialoghider, "f10" );

	if ( (ent = ini_register_entry("rc_color0", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.rc_color0, "0" );

	if ( (ent = ini_register_entry("rc_color1", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.rc_color1, "0" );

	if ( (ent = ini_register_entry("crasher_once", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.crasher_once, "false" );

	if ( (ent = ini_register_entry("crash_times", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.crash_times, "1" );

	if ( (ent = ini_register_entry("ap_cruise", TYPE_FLOAT)) != NULL )
		ini_register_data( ent, &set.ap_cruise, "120.0" );

	if ( (ent = ini_register_entry("ap_style", TYPE_INT)) != NULL )
		ini_register_data( ent, &set.ap_style, "3" );

	if ( (ent = ini_register_entry("ap_handling", TYPE_FLOAT)) != NULL )
		ini_register_data( ent, &set.ap_handling, "120.0" );

	if ( (ent = ini_register_entry("ap_stick", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.ap_stick, "false" );

	if ( (ent = ini_register_entry("ap_destination_name", TYPE_STRING)) != NULL )
	{
		for ( i = 0; i < AUTOPILOT_DEST_MAX; i++ )
			ini_register_data( ent, set.ap_destination_name + i, "" );
	}

	if ( (ent = ini_register_entry("ap_destination_pos", TYPE_COORD)) != NULL )
	{
		for ( i = 0; i < AUTOPILOT_DEST_MAX; i++ )
			ini_register_data( ent, set.ap_destination + i, "0.0 0.0 0.0 0" );
	}

	if ( (ent = ini_register_entry("infoboxes_near_playertags", TYPE_BOOL)) != NULL )
		ini_register_data( ent, &set.infoboxes_near_playertags, "false" );

	if ( (ent = ini_register_entry("key_console", TYPE_KEY)) != NULL )
		ini_register_data( ent, &set.key_console, "z" );
}
