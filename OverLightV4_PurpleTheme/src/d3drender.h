...
public:
	...
	HRESULT		PrintShadow ( float x, float y, DWORD color, const char *szText, bool bForceShadow = false);
	//HRESULT		ChatPrintShadow(float x, float y, DWORD color, const char *szText);
	...
	void SetFontName(char FontName[32]);
...
public:
	...
	void	D3DBoxBorderNewModSa(float x, float y, float w, float h, D3DCOLOR color);
	void	D3D_OL_Parallelogram(float x, float y, float w, float h, D3DCOLOR color);
	void	D3D_OL_Double_Parallelogram(float x, float y, float w, float h, D3DCOLOR color, D3DCOLOR color2);
	void	D3D_OL_Circle(float x, float y, float r, float fStart, float fEnd, D3DCOLOR color);
	void	D3D_OL_Circle2(float x, float y, float d, float fStart, float fEnd, D3DCOLOR color);
	void	D3D_OL_Rounded(float x, float y, float w, float h, D3DCOLOR color);
	void	D3D_OL_Label(const char *text, float x, float y, D3DCOLOR color, D3DCOLOR color2, D3DCOLOR textcolor);
	void	D3D_OL_Label_Top(const char *text, float x, float y, D3DCOLOR color, D3DCOLOR color2, D3DCOLOR textcolor);
	void	D3D_OL_Label_Right(const char *text, float x, float y, D3DCOLOR color, D3DCOLOR color2, D3DCOLOR textcolor);
	void	D3D_OL_Label_Left(const char *text, float x, float y, D3DCOLOR color, D3DCOLOR color2, D3DCOLOR textcolor);
	void	D3D_OL_LabelRounded(const char *text, float x, float y, D3DCOLOR color, D3DCOLOR textcolor);
	void	D3D_OL_BoxRounded(float x, float y, float w, float h, float r, D3DCOLOR color);

	void	D3D_OL_Trapezium(float x, float y, float w, float h, D3DCOLOR color);
	void	D3D_OL_Trapezium_Inverted(float x, float y, float w, float h, D3DCOLOR color);
	void	D3D_OL_Double_Trapezium(float x, float y, float w, float h, D3DCOLOR color, D3DCOLOR color2);
